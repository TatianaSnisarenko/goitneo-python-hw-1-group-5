...
class TestUserBirthdayFunctions(unittest.TestCase):
    ...
    def test_last_saturday(self):
        ...
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 10))
    ...
    def test_last_sunday(self):
        expected = ('Monday: Last Saturday, Last Sunday, Bill Mon',
                    'Tuesday: Bill Tue', 'Wednesday: Bill Wed',
                    'Thursday: Bill Thur', 'Friday: Bill Fri')
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 11))
        self.assertEqual(result, expected)
    ...
    def test_monday(self):
        expected = ('Monday: Last Saturday, Last Sunday, Bill Mon',
                    'Tuesday: Bill Tue', 'Wednesday: Bill Wed',
                    'Thursday: Bill Thur', 'Friday: Bill Fri')
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 12))
        self.assertEqual(result, expected)
    ...
    def test_tuesday(self):
        ...
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 13))
        self.assertEqual(result, expected)
    ...
    def test_wednesday(self):
        ...
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 14))
        self.assertEqual(result, expected)
    ...
    def test_thursday(self):
        ...
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 15))
        self.assertEqual(result, expected)
    ...
    def test_friday(self):
        ...
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 16))
        self.assertEqual(result, expected)
    ...
    def test_next_saturday(self):
        ...
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 17))
        self.assertEqual(result, expected)
    ...
    def test_next_sunday(self):
        expected = ('Monday: Next Saturday, Next Sunday, Next Monday', 
                    'Tuesday: Next Tuesday', 'Wednesday: Next Wednesday',
                    'Thursday: Next Thursday', 'Friday: Next Friday')
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 18))
        self.assertEqual(result, expected)
    ...
    def test_next_monday(self):
        expected = ('Monday: Next Saturday, Next Sunday, Next Monday', 
                    'Tuesday: Next Tuesday', 'Wednesday: Next Wednesday',
                    'Thursday: Next Thursday', 'Friday: Next Friday')
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 19))
        self.assertEqual(result, expected)
    ...
    def test_future_saturday(self):
        ...
        result = get_birthdays_per_week_from_date(self.users, datetime(2024, 2, 24))
        self.assertEqual(result, expected)
    ...
    def test_not_leap_year(self):
        ...
        result = get_birthdays_per_week_from_date(self.users, datetime(2025, 2, 24))
        self.assertEqual(result, expected)

    def test_next_year(self):
        # Today is 30th of december should include January and not February for next year
        expected = ('Monday: First Jan, Third Jan',)
        result = get_birthdays_per_week_from_date(self.users_next_year, datetime(2023, 12, 30))
        self.assertEqual(result, expected)

    def test_get_birthdays_per_week(self):
        today = datetime.today()
        users = [{'name':'Name Today', 'birthday':self.get_date(1992, today.month, today.day)}]
        for i in range(1, 10):
          ...
          birthday = self.get_date(1992, date.month, date.day)
          users.append({'name':name, 'birthday':birthday})
        print("Exected 5 days to be printed: 3 names for Monday and 1 day for other working days")
